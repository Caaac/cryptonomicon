    ...
    <div class="container mx-auto flex flex-col items-center bg-gray-100 p-4">
        ...
        <div class="container">
            <section>
                ...
                <button
                    @click="addTiker"
                    :disabled="checkSimilarTiker"
                    :class="{'opacity-50' : checkSimilarTiker}"
                    type="button"
            ...
            <template v-if="tikers.length !== 0">
                ...
                <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
                    <div
                        ...
                        :class="{
                            'border-4' : selectTiker === tiker,
                            'border-2' : selOverTiker === tiker,
                        }"
            ...
            <section v-if="selectTiker" class="relative">
